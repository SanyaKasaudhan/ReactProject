...
import { MDBRow,MDBIcon, MDBCol, MDBInput, MDBBtn, MDBCard, MDBCardBody } from "mdbreact";
...
class FormsPage extends React.Component {
  ...
  render() {
    return (
      <div className="form" style={{paddingLeft:"300px", paddingTop: "55px"}}>
          <form
          className='needs-validation'
          onSubmit={this.submitHandler}
          noValidate
        >
          <MDBCard style={{width: "555px", paddingLeft:"55px"}}>
            <MDBCardBody>
